...
/** Brand glyphs as inline SVG (lucide v1 dropped brand icons). currentColor-driven. */
...
export function GooglePlayIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" {...props}>
      <path d="M3.6 1.8 13.4 12 3.6 22.2c-.32-.2-.5-.57-.5-1V2.8c0-.43.18-.8.5-1Zm11.2 11.6 2.62 2.63-9.2 5.27 6.58-7.9Zm3.9-3.9 2.78 1.6c.62.36.62 1.34 0 1.7l-2.78 1.6-2.9-2.45 2.9-2.45ZM8.22 2.7l9.2 5.27-2.62 2.63L8.22 2.7Z" />
    </svg>
  );
}
